...
| `Product` |  |  | `String(40)` | Y | Product |  | _Product | S/4 only entity |
...
| `LastChangeDate` | `MARA` | `LAEDA` | `Date` |  | Last Change |  |  |  |
...
| `ProductGroup` | `MARA` | `MATKL` | `String(9)` |  | Product Group |  | _ProductGroup_2 |  |
...
| `SizeOrDimensionText` | `MARA` | `GROES` | `String(32)` |  | Size/dimensions |  |  |  |
| `IndustryStandardName` | `MARA` | `BISMT` | `String(18)` |  | Industry Std Desc. |  |  |  |
...
| CDS Field | ABAP Table | ABAP Field | Type | Key | Label | Currency/UOM Ref | FK Association | ECC / S4 Diff |
|---|---|---|---|---|---|---|---|---|
| `ProductGroup` |  |  | `String(9)` | Y | Product Group |  | _ProductGroup | S/4 only entity |
| `Language` |  |  | `String(2)` | Y | Language Key |  |  | S/4 only entity |
...
| `ConfigurableProduct` |  |  | `String(40)` |  | Conf. Material |  | _ConfigurableProduct | S/4 only entity |
...
| `ConsumptionRefUsageEndDate` |  |  | `Date` |  | Date to |  |  | S/4 only entity |
| `ConsumptionQtyMultiplier` |  |  | `Decimal(4,2)` |  | Multiplier |  |  | S/4 only entity |
| `ConsumptionReferenceProduct` |  |  | `String(40)` |  | RefMatl: consumption |  | _ConsumptionReferenceProduct | S/4 only entity |
| `ConsumptionReferencePlant` |  |  | `String(4)` |  | RefPlant:consumption |  |  | S/4 only entity |
...
| `PricingReferenceProduct` |  |  | `String(40)` |  | Pricing Ref. Matl |  | _PricingReferenceProduct | S/4 only entity |
...
|---|---|---|---|---|---|---|---|---|
| `Product` |  |  | `String(40)` | Y | Material |  |  | S/4 only entity |
| `StorageConditions` |  |  | `String(2)` |  | Storage conditions |  | _Storagecondition | S/4 only entity |
