...
| CDS Field | ABAP Table | ABAP Field | Type | Key | Label | Currency/UOM Ref | FK Association | ECC / S4 Diff |
|---|---|---|---|---|---|---|---|---|
| `FunctionalAreaHierarchy` |  |  | `String(42)` | Y | Func. Area Hierarchy |  | _Hierarchy | S/4 only entity |
...
| `FunctionalArea` |  |  | `String(16)` |  | Functional Area |  | _FunctionalArea | S/4 only entity |
